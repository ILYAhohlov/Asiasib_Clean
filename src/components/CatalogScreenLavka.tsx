      ...
      <div className="p-3 space-y-2">
        ...
        <div className="flex items-center justify-between bg-gray-50 rounded-xl p-2">
          <button
            ...
            className="w-8 h-8 bg-red-500 text-white rounded-full hover:bg-red-600 disabled:opacity-50 flex items-center justify-center"
          >
            <Minus className="w-4 h-4" />
          </button>

          <span className="font-bold text-sm">{quantity} {product.unit}</span>
        ...
        <button
          ...
          className="w-full bg-green-500 hover:bg-green-600 text-white py-2 px-3 font-bold disabled:opacity-50 text-sm rounded-xl transition-all duration-200"
        >
          В корзину
        </button>
      </div>
        ...
        <div className="px-4 py-4">
          ...
          <div className="text-center mb-4">
            <h1 className="text-xl font-bold">
              ...
              <span className="text-gray-900 text-sm block">оптовый рынок</span>
            </h1>
          </div>
          ...
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-12 pr-4 py-3 bg-gray-100 rounded-2xl focus:outline-none focus:ring-2 focus:ring-red-500 text-sm"
            />
          </div>
        </div>
      </header>
          ...
          <div className="flex space-x-3 pb-2">
            {categories.map(category => (
              <button
                ...
                className={`flex-shrink-0 flex flex-col items-center p-3 rounded-2xl transition-all duration-200 min-w-[80px]
