              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    className="admin-input w-full rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                  />
                </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    className="admin-input w-full rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500"
                  />
                </div>
                ...
                <div className="md:col-span-2">
                  ...
                  <textarea
                    ...
                    className="admin-input w-full h-20 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500"
                  />
                </div>
                ...
                <div>
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    <label
                      ...
                      className="admin-input flex items-center space-x-2 px-4 py-2 rounded-lg cursor-pointer hover:bg-gray-50"
                    >
                ...
                <div className="flex space-x-2">
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="admin-input pl-10 pr-4 py-2 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-500"
                    />
                  </div>
                  ...
                  <select
                    ...
                    className="admin-input rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500"
                  >
