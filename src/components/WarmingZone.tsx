...
export function WarmingZone({ onProductClick, onScrollToProduct }: WarmingZoneProps) {
  ...
  return (
    <div className="border border-gray-200 p-3 mb-4 shadow-sm w-full sm:w-96 lg:w-[500px] xl:w-[600px]" style={{ background: 'linear-gradient(to bottom, #10b981, #06b6d4)', borderRadius: '12px' }}>
      <div className="flex items-center justify-between mb-2">
        <h3 className="text-xs font-bold text-gray-800">🔥 Хиты</h3>
        <span className="text-xs text-gray-500">Топ</span>
      </div>
      
      <div className="flex gap-3" style={{ height: '30vh' }}>
